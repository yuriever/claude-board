...
* `audits/codex-desktop-ipc-probe.md`: evidence for the Codex Desktop IPC monitor route.
* `reports/codex-desktop-ipc-investigation.md`: Chinese investigation report explaining the Desktop IPC route and rejected alternatives.
* `backlog.md`: open follow-up work that is not part of completed implementation phases.
* `plans/original/`: original long-form implementation plans, including active plans before they are completed.
...
* Put explanatory investigation reports under `reports/`.
* Put unfinished follow-up work in `backlog.md`.
* Keep original implementation plans under `plans/original/`; after implementation, they remain there as historical archives.
